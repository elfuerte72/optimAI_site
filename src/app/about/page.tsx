...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className={`${notoSansJP.className} bg-black text-white min-h-screen py-16 px-4 sm:px-6 lg:px-8`}>
      <style jsx global>{`
        @keyframes fadeIn {
      ...
      <div className="container mx-auto">
        ...
        <header 
          className={`flex items-center justify-start mb-20 ${initialAnimationState} ${fadeInAnimationClass} max-w-3xl mx-auto`} 
          style={{ animationDelay: '0.1s' }}
        >
          <div className="text-5xl md:text-6xl font-extrabold tracking-tight flex-shrink-0">
            Optima<span className="subheading-gradient">AI</span>
          </div>
          <span className="text-3xl md:text-4xl font-extrabold mx-4">-</span>
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight subheading-gradient">
            Ближе к будущему
          </h1>
        </header>
        ...
        <section 
          className={`mb-16 ${initialAnimationState} ${fadeInAnimationClass} max-w-3xl mx-auto`} 
          style={{ animationDelay: '0.3s' }}
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-left text-white">
            Мы — энтузиасты в сфере искусственного интеллекта.
          </h2>
          <p className="text-xl md:text-2xl text-neutral-300 text-left leading-relaxed">
        ...
        <div className={`space-y-16 mb-16 max-w-3xl mx-auto`}>
          ...
          >
            <h3 className="text-3xl font-semibold mb-4 text-white">Наша миссия</h3>
          ...
          >
            <h3 className="text-3xl font-semibold mb-4 text-white">Наше видение</h3>
            <p className="text-lg text-neutral-300 leading-relaxed">
        ...
        <section 
          className={`mb-16 ${initialAnimationState} ${slideInLeftAnimationClass} max-w-3xl mx-auto`} 
          style={{ animationDelay: '0.9s' }}
        >
          <h3 className="text-4xl font-bold mb-8 text-left text-white">Наши ценности</h3>
          <div className="space-y-8">
            {[
              ...
              >
                <h4 className="text-2xl font-semibold mb-2 text-white">{value.title}</h4>
                <p className="text-lg text-neutral-300 leading-relaxed">{value.description}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        >
          <h3 className="text-4xl font-bold mb-8 text-left text-white">Команда основателей</h3>
