...
const ClientPrivacyPage = dynamic(() => import('./ClientPrivacyPage'), {
    loading: () => (
...
export const metadata: Metadata = {
    ...
    description: 'Политика конфиденциальности сайта OptimaAI - порядок обработки персональных данных пользователей',
};
