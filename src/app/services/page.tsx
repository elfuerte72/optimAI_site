        ...
        <FadeInSection delay={0.2}>
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto">
              ...
              <div className="flex gap-4">
                <div className="w-12 h-12 flex-shrink-0"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="url(#iconGradientServices)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M7 8L3 12L7 16"></path><path d="M17 8L21 12L17 16"></path><path d="M14 4L10 20"></path></svg></div>
                <div>
                ...
                <table className="min-w-full divide-y divide-gray-700">
                  ...
                  <tbody className="bg-black divide-y divide-gray-700">
                    <tr>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-300 text-center"><div className="mb-2">–&nbsp;<strong className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">30–60%</strong>&nbsp;времени на поиск/обработку информации</div><div className="mb-2">+&nbsp;<strong className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">40–70%</strong>&nbsp;скорость решения бытовых задач</div><div>+&nbsp;<strong className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">2–3</strong>&nbsp;ч свободного времени в сутки</div></td>
